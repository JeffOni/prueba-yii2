...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Atributo virtual para entrada de contraseña en formularios
     */
    public $password;
    ...
    {
        return [
            // Reglas para escenario 'create'
            [['username', 'email', 'password'], 'required', 'on' => 'create'],

            // Reglas para escenario 'update'
    ...
    /**
     * Retorna el nombre del estado del usuario
     * @return string
     */
    ...
    {
        $data = \common\modules\api\v1\models\JwtHelper::validateToken($token);
